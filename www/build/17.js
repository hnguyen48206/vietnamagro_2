...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminNewsDetailsPageModule", function() { return AdminNewsDetailsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__admin_news_details__ = __webpack_require__(876);
...
var AdminNewsDetailsPageModule = /** @class */ (function () {
    function AdminNewsDetailsPageModule() {
    }
    AdminNewsDetailsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__admin_news_details__["a" /* AdminNewsDetailsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__admin_news_details__["a" /* AdminNewsDetailsPage */]),
            ],
        })
    ], AdminNewsDetailsPageModule);
    return AdminNewsDetailsPageModule;
}());

//# sourceMappingURL=admin-news-details.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminNewsDetailsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(121);
 ...
 */
var AdminNewsDetailsPage = /** @class */ (function () {
    function AdminNewsDetailsPage(newsFirebaseController, sanitizer, alertCtrl, fbservices, global, menuCrtl, navCtrl, navParams) {
    ...
    AdminNewsDetailsPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    AdminNewsDetailsPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AdminAboutusPage');
    };
    AdminNewsDetailsPage.prototype.ionViewWillEnter = function () {
    ...
    AdminNewsDetailsPage.prototype.textAreaResize = function () {
    ...
    AdminNewsDetailsPage.prototype.fileChangeListener = function ($event) {
    ...
    AdminNewsDetailsPage.prototype.fileListToArray = function (fileList) {
        return Array.prototype.slice.call(fileList);
    };
    AdminNewsDetailsPage.prototype.removeFileFromList = function (filename) {
    ...
    AdminNewsDetailsPage.prototype.validateInput = function () {
        var _this = this;
        if (this.itemInput.title == '' || this.itemInput.detail == '')
            this.global.presentToast('Các trường bắt buộc không thể bỏ trống');
        else {
            this.newsFirebaseController.updateNews(this.currentChosenCatergory, this.itemInput.id, this.itemInput).then(function () {
    ...
    AdminNewsDetailsPage.prototype.mediaUpload = function () {
        var _this = this;
        ...
        for (var _i = 0, _a = this.mediaListToSend; _i < _a.length; _i++) {
            ...
            promiseList.push(this.fbservices.fbUploadFiles(media, 'news').then(function (res) {
                ...
                console.log(res);
                //saveurl to news
                _this.newsFirebaseController.addNewsMediaFileURLToDocumentObject(res, _this.currentChosenCatergory, _this.itemInput.id);
            }).catch(function (err) {
                console.log(err);
            }));
        }
    ...
    AdminNewsDetailsPage.prototype.openListOfCurrentMedia = function () {
        this.modificationMediaList = Array.from(this.originalItemInput.mediaList);
        this.editMedia = true;
    };
    AdminNewsDetailsPage.prototype.closeListOfCurrentMedia = function () {
        this.editMedia = false;
        this.modificationMediaList = [];
    };
    AdminNewsDetailsPage.prototype.refreshModification = function () {
        this.modificationMediaList = Array.from(this.originalItemInput.mediaList);
    };
    AdminNewsDetailsPage.prototype.deleteModification = function (item) {
        if (item == null)
            this.modificationMediaList = [];
        else
    ...
    AdminNewsDetailsPage.prototype.reorderItems = function (indexes) {
    ...
    AdminNewsDetailsPage.prototype.confirmMediaModification = function () {
        var _this = this;
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            promiseList.push(_this.newsFirebaseController.setMediaArrayToDocument(_this.modificationMediaList, _this.currentChosenCatergory, _this.itemInput.id));
                            var self = _this;
                            Promise.all(promiseList).then(function (values) {
                                self.global.dismissLoading();
    ...
    return AdminNewsDetailsPage;
}());

//# sourceMappingURL=admin-news-details.js.map
