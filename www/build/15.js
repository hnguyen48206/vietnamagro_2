...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminProcessDetailPageModule", function() { return AdminProcessDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__admin_process_detail__ = __webpack_require__(878);
...
var AdminProcessDetailPageModule = /** @class */ (function () {
    function AdminProcessDetailPageModule() {
    }
    AdminProcessDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__admin_process_detail__["a" /* AdminProcessDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__admin_process_detail__["a" /* AdminProcessDetailPage */]),
            ],
        })
    ], AdminProcessDetailPageModule);
    return AdminProcessDetailPageModule;
}());

//# sourceMappingURL=admin-process-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminProcessDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(121);
 ...
 */
var AdminProcessDetailPage = /** @class */ (function () {
    function AdminProcessDetailPage(processFirebaseController, sanitizer, alertCtrl, fbservices, global, menuCrtl, navCtrl, navParams) {
    ...
    AdminProcessDetailPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    AdminProcessDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AdminAboutusPage');
    };
    AdminProcessDetailPage.prototype.ionViewWillEnter = function () {
    ...
    AdminProcessDetailPage.prototype.textAreaResize = function () {
    ...
    AdminProcessDetailPage.prototype.fileChangeListener = function ($event) {
    ...
    AdminProcessDetailPage.prototype.fileListToArray = function (fileList) {
        return Array.prototype.slice.call(fileList);
    };
    AdminProcessDetailPage.prototype.removeFileFromList = function (filename) {
    ...
    AdminProcessDetailPage.prototype.validateInput = function () {
        var _this = this;
        if (this.itemInput.title == '' || this.itemInput.detail == '')
            this.global.presentToast('Các trường bắt buộc không thể bỏ trống');
        else {
            this.processFirebaseController.updateNews(this.currentChosenCatergory, this.itemInput.id, this.itemInput).then(function () {
    ...
    AdminProcessDetailPage.prototype.mediaUpload = function () {
        var _this = this;
        ...
        for (var _i = 0, _a = this.mediaListToSend; _i < _a.length; _i++) {
            ...
            promiseList.push(this.fbservices.fbUploadFiles(media, 'news').then(function (res) {
                ...
                console.log(res);
                //saveurl to news
                _this.processFirebaseController.addNewsMediaFileURLToDocumentObject(res, _this.currentChosenCatergory, _this.itemInput.id);
            }).catch(function (err) {
                console.log(err);
            }));
        }
    ...
    AdminProcessDetailPage.prototype.openListOfCurrentMedia = function () {
        this.modificationMediaList = Array.from(this.originalItemInput.mediaList);
        this.editMedia = true;
    };
    AdminProcessDetailPage.prototype.closeListOfCurrentMedia = function () {
        this.editMedia = false;
        this.modificationMediaList = [];
    };
    AdminProcessDetailPage.prototype.refreshModification = function () {
        this.modificationMediaList = Array.from(this.originalItemInput.mediaList);
    };
    AdminProcessDetailPage.prototype.deleteModification = function (item) {
        if (item == null)
            this.modificationMediaList = [];
        else
    ...
    AdminProcessDetailPage.prototype.reorderItems = function (indexes) {
    ...
    AdminProcessDetailPage.prototype.confirmMediaModification = function () {
        var _this = this;
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            promiseList.push(_this.processFirebaseController.setMediaArrayToDocument(_this.modificationMediaList, _this.currentChosenCatergory, _this.itemInput.id));
                            var self = _this;
                            Promise.all(promiseList).then(function (values) {
                                self.global.dismissLoading();
    ...
    return AdminProcessDetailPage;
}());

//# sourceMappingURL=admin-process-detail.js.map
